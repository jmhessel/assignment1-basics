...
def run_embedding(
    ...
    layer.load_state_dict({"embs": weights})
    return layer(x=token_ids)
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    _run_train_bpe(input_path=input_path, vocab_size=vocab_size, special_tokens=special_tokens, kwargs=kwargs)
